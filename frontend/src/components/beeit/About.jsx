        ...
        <section ref={containerRef} className="relative py-32 bg-background overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row gap-16 relative z-10">
                ...
                <div className="lg:w-1/3 lg:h-[calc(100vh-200px)] lg:sticky lg:top-32 flex flex-col justify-center" ref={leftColRef}>
                    ...
                    <div className="space-y-6 text-gray-600 leading-relaxed text-lg border-l-2 border-primary/20 pl-6">
                        <p>
                            Trực thuộc <strong className="text-orange-600">FPT Polytechnic</strong>, chúng tôi không chỉ là một câu lạc bộ.
                        </p>
                        <p>
                            Chúng tôi là một <span className="text-black italic">"Tổ Ong Kỹ Thuật Số"</span> (Digital Hive) - nơi những dòng code kiến tạo tương lai và niềm đam mê công nghệ được kết nối không giới hạn.
                        </p>
                    </div>
                ...
                <div className="lg:w-2/3" ref={cardsRef}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* Card 1: MỤC TIÊU */}
                        <div className="about-card group relative p-8 bg-white border border-gray-200 rounded-2xl transition-all duration-500 hover:scale-[1.02] hover:border-[#FFD60A] hover:bg-gray-50 hover:shadow-[0_20px_50px_rgba(255,214,10,0.1)]">
                            <div className="absolute top-0 right-0 p-6 opacity-20 group-hover:opacity-30 transition-opacity">
                                <Target size={64} className="text-black stroke-1" />
                            </div>
                            <div className="mb-6 relative">
                                {/* Hexagon Shape CSS */}
                                <div className="w-14 h-16 bg-orange-100 flex items-center justify-center text-orange-600" style={{ clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" }}>
                                    <Target size={24} />
                                </div>
                            </div>
                        ...
                        <div className="about-card group relative p-8 bg-white border border-gray-200 rounded-2xl transition-all duration-500 hover:scale-[1.02] hover:border-[#FFD60A] hover:bg-gray-50 hover:shadow-[0_20px_50px_rgba(255,214,10,0.1)]">
                            <div className="absolute top-0 right-0 p-6 opacity-20 group-hover:opacity-30 transition-opacity">
                                <Flag size={64} className="text-black stroke-1" />
                            </div>
                            <div className="mb-6 relative">
                                <div className="w-14 h-16 bg-yellow-100 flex items-center justify-center text-yellow-700" style={{ clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" }}>
                                    <Flag size={24} />
                                </div>
                            </div>
                        ...
                        <div className="about-card group relative p-8 bg-white border border-gray-200 rounded-2xl transition-all duration-500 hover:scale-[1.02] hover:border-[#FFD60A] hover:bg-gray-50 hover:shadow-[0_20px_50px_rgba(255,214,10,0.1)]">
                            <div className="absolute top-0 right-0 p-6 opacity-20 group-hover:opacity-30 transition-opacity">
                                <Zap size={64} className="text-black stroke-1" />
                            </div>
                            <div className="mb-6 relative">
                                <div className="w-14 h-16 bg-blue-100 flex items-center justify-center text-blue-600" style={{ clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" }}>
                                    <Zap size={24} />
                                </div>
                            </div>
                        ...
                        <div className="about-card group relative p-8 bg-white border border-gray-200 rounded-2xl transition-all duration-500 hover:scale-[1.02] hover:border-[#FFD60A] hover:bg-gray-50 hover:shadow-[0_20px_50px_rgba(255,214,10,0.1)]">
                            <div className="absolute top-0 right-0 p-6 opacity-20 group-hover:opacity-30 transition-opacity">
                                <Users size={64} className="text-black stroke-1" />
                            </div>
                            <div className="mb-6 relative">
                                <div className="w-14 h-16 bg-green-100 flex items-center justify-center text-green-600" style={{ clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" }}>
                                    <Users size={24} />
                                </div>
                            </div>
