...
const TheKernel = ({ leaders = [] }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-1/2 h-1/2 md:h-full flex flex-col justify-center px-6 md:px-16 lg:px-24 relative bg-background border-t border-gray-200 md:border-t-0 md:border-l">
        {/* Background Elements */}
        <div className="absolute top-0 right-0 p-8 opacity-10 pointer-events-none">
          <ArrowRight size={100} className="text-gray-900 -rotate-45" />
        </div>

        <div className="max-w-xl">
          {/* 1. Counter / Status */}
          <div className="flex items-end gap-4 mb-8 text-gray-400 font-mono">
            <span className="kernel-counter text-6xl font-bold text-gray-200 block leading-none">
              0{activeIndex + 1}
            </span>
            <span className="text-sm pb-2">/ 0{displayLeaders.length}</span>
            <div className="h-[1px] flex-1 bg-gray-200 mb-2">
              <div
          ...
          <p className="kernel-bio text-lg md:text-xl text-gray-600 font-light leading-relaxed mb-10 border-l-2 border-primary/20 pl-6">
            {activeLeader.bio}
          </p>
        ...
        <div className="absolute bottom-8 right-8 font-mono text-[10px] text-gray-400 animate-pulse hidden md:block">
