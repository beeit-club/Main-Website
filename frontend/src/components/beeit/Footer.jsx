...
const Footer = ({ data }) => {
    ...
    const ctx = gsap.context(() => {
      gsap.from(footerRef.current, {
        ...
        scrollTrigger: {
          ...
          start: "top 90%", // Trigger slightly before it's fully in view
  ...
  return (
    <footer ref={footerRef} className=" bottom-0 h-[600px] md:h-[500px] w-full  text-green-500 font-mono z-0 flex flex-col justify-center border-t border-green-900/30">
