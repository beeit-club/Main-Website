...
export default async function sitemap() {
  ...
  try {
    ...
    if (
      ...
      console.error(`[Sitemap] Failed to fetch posts: ${error.message}`);
    }
  }
  ...
  try {
    ...
    if (
      ...
      // Log simple error in production build to allow debugging without leaking too much info if sensitive
      console.error(`[Sitemap] Failed to fetch events: ${error.message}`);
    }
  }
  ...
  try {
    ...
    if (
      ...
      console.error(`[Sitemap] Failed to fetch questions: ${error.message}`);
    }
  }
