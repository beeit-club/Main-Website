...
import { columns } from "@/components/admin/components/founders/columns";
import { DataTable } from "@/components/admin/components/founders/data-table";
...
export default function FoundersPage() {
  ...
  async function getItems() {
    ...
    try {
      const service =
        viewMode === "active"
          ? founderService.getAll
          : founderService.getDeleted;
  ...
  return (
    <div className="container mx-auto py-6 space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Quản lý Founders & Members</h1>
          <p className="text-muted-foreground">
            Quản lý thông tin Người sáng lập và Ban Chủ Nhiệm
          </p>
        </div>
        <Link href="/admin/landing/founders/add">
          <Button>
