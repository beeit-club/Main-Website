...
-- ============================================
-- BẢNG KHÔNG CÓ PHỤ THUỘC (Tạo đầu tiên)
-- ============================================
...
) ENGINE=InnoDB AUTO_INCREMENT=269 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;

-- Data exporting was unselected.

-- Dumping structure for table beeit.email_template_categories
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci COMMENT='Danh mục email templates';

-- Data exporting was unselected.

-- ============================================
-- BẢNG PHỤ THUỘC VÀO ROLES
-- ============================================
...
) ENGINE=InnoDB AUTO_INCREMENT=115 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
CREATE TABLE IF NOT EXISTS `interview_schedules` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL COMMENT 'VD: Đợt 1 - Online Google Meet',
  ...
  `location` text CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci COMMENT 'Link Meet hoặc Địa điểm',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci COMMENT 'Mô tả thêm',
  `created_by` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- Dumping structure for table beeit.email_templates
CREATE TABLE IF NOT EXISTS `email_templates` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL COMMENT 'Tên template (unique)',
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL COMMENT 'Slug cho template (unique)',
  ...
  `html_content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL COMMENT 'Nội dung HTML (Handlebars template)',
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci COMMENT 'Mô tả template',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci COMMENT='Email templates động - có thể quản lý qua admin panel';

-- Data exporting was unselected.

-- ============================================
-- BẢNG PHỤ THUỘC VÀO USERS + SELF-REFERENCE
-- ============================================
...
-- ============================================
-- BẢNG PHỤ THUỘC VÀO POST_CATEGORIES + USERS
-- ============================================
...
-- ============================================
-- BẢNG PHỤ THUỘC VÀO POSTS + USERS
-- ============================================
...
-- ============================================
-- BẢNG PHỤ THUỘC VÀO QUESTIONS + USERS
-- ============================================
...
-- ============================================
-- BẢNG PHỤ THUỘC VÀO DOCUMENT_CATEGORIES + USERS
-- ============================================
...
-- ============================================
-- BẢNG PHỤ THUỘC VÀO DOCUMENTS + USERS
-- ============================================
...
-- ============================================
-- BẢNG PHỤ THUỘC VÀO EMAIL_TEMPLATES + USERS
-- ============================================

-- Dumping structure for table beeit.email_custom_variables
CREATE TABLE IF NOT EXISTS `email_custom_variables` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `template_id` bigint unsigned DEFAULT NULL COMMENT 'NULL = global variable, có ID = template-specific',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL COMMENT 'Tên biến (unique trong phạm vi template_id)',
  `type` enum('expression','helper','function') CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL DEFAULT 'expression' COMMENT 'Loại biến: expression, helper, function',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci COMMENT 'Mô tả biến',
  `expression` text CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci COMMENT 'Expression để tính toán (nếu type=expression)',
  `dependencies` json DEFAULT NULL COMMENT 'Danh sách các biến mà expression này phụ thuộc vào',
  `helper_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci DEFAULT NULL COMMENT 'Tên helper function (nếu type=helper)',
  `helper_params` json DEFAULT NULL COMMENT 'Tham số cho helper function',
  `function_code` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci COMMENT 'Code JavaScript (nếu type=function)',
  `return_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL DEFAULT 'string' COMMENT 'Kiểu dữ liệu trả về: string, number, boolean, date, object',
  `is_active` tinyint(1) DEFAULT '1' COMMENT 'Biến có đang active không',
  `created_by` bigint unsigned DEFAULT NULL,
  `updated_by` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Dumping structure for table beeit.email_logs
CREATE TABLE IF NOT EXISTS `email_logs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `template_id` bigint unsigned DEFAULT NULL COMMENT 'ID của template được sử dụng',
  `template_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci DEFAULT NULL COMMENT 'Tên template (backup nếu template bị xóa)',
  `template_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci DEFAULT NULL COMMENT 'Slug template (backup)',
  `recipient_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL COMMENT 'Email người nhận',
  `subject` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL COMMENT 'Subject đã render',
  `status` enum('pending','sent','failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci DEFAULT 'pending' COMMENT 'Trạng thái gửi',
  `error_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci COMMENT 'Lỗi nếu gửi thất bại',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci COMMENT='Log các email đã gửi - dùng để tracking và analytics';

-- Data exporting was unselected.

-- Dumping structure for table beeit.email_batch_jobs
CREATE TABLE IF NOT EXISTS `email_batch_jobs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `template_id` bigint unsigned DEFAULT NULL COMMENT 'ID của template được sử dụng',
  `template_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci DEFAULT NULL COMMENT 'Slug template (backup)',
  `job_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL COMMENT 'Tên job (mô tả)',
  `status` enum('pending','processing','completed','failed','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci DEFAULT 'pending' COMMENT 'Trạng thái job',
  ...
  `error_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci COMMENT 'Lỗi nếu job thất bại',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci COMMENT='Batch jobs cho gửi email hàng loạt';

-- Data exporting was unselected.

-- ============================================
-- BẢNG PHỤ THUỘC VÀO EMAIL_BATCH_JOBS
-- ============================================

-- Dumping structure for table beeit.email_batch_recipients
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci COMMENT='Danh sách recipients trong mỗi batch job';

-- Data exporting was unselected.

-- ============================================
-- BẢNG PHỤ THUỘC VÀO EVENTS + USERS
-- ============================================
...
-- ============================================
-- BẢNG PHỤ THUỘC VÀO EVENTS + EVENT_REGISTRATIONS + USERS
-- ============================================
...
-- ============================================
-- BẢNG PHỤ THUỘC VÀO INTERVIEW_SCHEDULES
-- ============================================
...
CREATE TABLE IF NOT EXISTS `membership_applications` (
  ...
  `student_year` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
